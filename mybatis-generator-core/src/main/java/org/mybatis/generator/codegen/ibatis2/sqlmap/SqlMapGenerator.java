...
public class SqlMapGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        answer.addAttribute(new Attribute("namespace", introspectedTable.getIbatis2SqlMapNamespace())); //$NON-NLS-1$
        ...
        addSelectByMapConditionElement(answer);
    ...
    protected void addSelectByMapConditionElement(XmlElement parentElement) {
//        if (introspectedTable.getRules().generateSelectByPrimaryKey()) {
//            AbstractXmlElementGenerator elementGenerator = new SelectByPrimaryKeySelectiveElementGenerator();
//            initializeAndExecuteGenerator(elementGenerator, parentElement);
//        }
    }
}
