 ...
 * 
 */
public class SelectByMapConditionMethodGenerator extends AbstractJavaMapperMethodGenerator {

    public SelectByMapConditionMethodGenerator() {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getSelectByMapConditionListStatementId());
        method.addParameter(new Parameter(new FullyQualifiedJavaType("Map<String, Object>"), "parameter"));//$NON-NLS-1$
