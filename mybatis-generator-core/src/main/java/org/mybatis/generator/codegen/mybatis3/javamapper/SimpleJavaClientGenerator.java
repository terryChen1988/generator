...
public class SimpleJavaClientGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByMapConditionElement(interfaze);
    ...
    protected void addSelectByMapConditionElement(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new SelectByMapConditionMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
