...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByMapConditionMethodGenerator;
...
public class DAOGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByMapConditionElement(topLevelClass, interfaze);
    ...
    protected void addSelectByMapConditionElement(TopLevelClass topLevelClass, Interface interfaze) {
//        AbstractDAOElementGenerator methodGenerator = new SelectByMapConditionMethodGenerator();
