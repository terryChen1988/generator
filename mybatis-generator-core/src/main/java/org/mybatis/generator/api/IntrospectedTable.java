...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_SELECT_BY_MAP_CONDITION_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByMapConditionStatementId("selectByMapCondition"); //$NON-NLS-1$
    ...
    public void setSelectByMapConditionStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_MAP_CONDITION_STATEMENT_ID, s);
    }
    ...
    public String getSelectByMapConditionListStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_MAP_CONDITION_STATEMENT_ID);
    }
